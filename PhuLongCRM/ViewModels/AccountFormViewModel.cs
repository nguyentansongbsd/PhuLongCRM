...
namespace PhuLongCRM.ViewModels
{
    public class AccountFormViewModel : BaseViewModel
    {
        ...
        private async Task<object> getContent()
        {
            ...
            data["bsd_issuedon"] = singleAccount.bsd_issuedon.HasValue ? singleAccount.bsd_issuedon.Value.ToLocalTime().ToString("yyyy-MM-dd") : null; /*(DateTime.Parse(singleAccount.bsd_issuedon.ToString()).ToLocalTime()).ToString("yyyy-MM-dd\"T\"HH:mm:ss\"Z\"") : null;*/
