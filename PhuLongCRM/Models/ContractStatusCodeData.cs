...
namespace PhuLongCRM.Models
{
    public class ContractStatusCodeData
    {
        public static List<StatusCodeModel> ContractStatusData()
        {
            ...
            {
                new StatusCodeModel("100000001",Language.contract_1st_installment_sts,"#F43927"), // thanh toán đợt 1 contract_1st_installment_sts //  1st Installment  2
                new StatusCodeModel("100000003",Language.contract_being_payment_sts,"#93B5EB"), // contract_being_payment_sts //Being Payment 3
                ...
                new StatusCodeModel("100000007",Language.contract_qualify_sts,"#FFDF0A"),// contract_converted_sts //Qualify 2
                new StatusCodeModel("100000005",Language.contract_handover_sts,"#9EC749"),// contract_handover_sts //Quanlify - Units Handover 3
                ...
                new StatusCodeModel("100000000",Language.contract_option_sts,"#ffc43d"), // contract_option_sts //Option 2
                ...
                new StatusCodeModel("100000002",Language.contract_signed_contract_sts,"#016C70"), // đã ký hợp đồng // contract_signed_contract_sts //Signed Contract 3
                new StatusCodeModel("100000006",Language.contract_terminated_sts,"#c4c4c4"), // đã thanh lý // contract_terminated_sts //Terminated 
                new StatusCodeModel("100000008",Language.contract_signed_da_sts,"#FF869E"), // ???? // contract_signed_da_sts //Signed D.A 2
                new StatusCodeModel("100000009",Language.contract_acceptance_sts,"#DE7962"), // ???? // contract_acceptance_sts //Acceptance 3
                new StatusCodeModel("100000010",Language.contract_units_handover_sts,"#7D9D9C"), // ???? // contract_units_handover_sts //Units Handover 3
