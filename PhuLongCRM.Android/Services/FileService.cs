...
using Android.OS;
using Xamarin.Forms;
using support = Android.Support.V4;
using application = Android.App;
using PhuLongCRM.Controls;
using PhuLongCRM.Droid;
...
namespace PhuLongCRM.Droid
{
    public class FileService : IFileService
    {
        ...
        {
            //var documentsPath = Environment.GetFolderPath(Environment.SpecialFolder.LocalizedResources);
        ...
        public void OpenFile(string fileName, string location = "Download/Conasi")
        {
            ...
            var fileURI = support.Content.FileProvider.GetUriForFile(
              application.Application.Context, "ConasiCRM.Android.fileprovider", fileLocation);

            intent.SetDataAndType(fileURI, _mappings[fileExtension]);

            application.Application.Context.StartActivity(intent);
        }

        private static IDictionary<string, string> _mappings = new Dictionary<string, string>(System.StringComparer.InvariantCultureIgnoreCase) {
